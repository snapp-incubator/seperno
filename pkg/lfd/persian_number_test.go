...
func TestConvertWordsToIntFa(t *testing.T) {
	tests := []struct {
		...
		// Simple single digits
		{
			...
			input:    "سوم",
			expected: "3",
			numbers:  []DetectedNumber{{Number: 3}},
		},
		{
			name:     "ordinal_first",
			input:    "اول",
			expected: "1",
			numbers:  []DetectedNumber{{Number: 1}},
		},
		{
			name:     "ordinal_second_with_suffix",
			input:    "دومین",
			expected: "2",
			numbers:  []DetectedNumber{{Number: 2}},
		},
		{
			name:     "ordinal_fourth_with_suffix",
			input:    "چهارمین",
			expected: "4",
			numbers:  []DetectedNumber{{Number: 4}},
		},
		{
			name:     "street_one",
			input:    "خیابان یک",
		...
		},
		{
			...
			numbers:  []DetectedNumber{{Number: 9}},
		},
		...
		// Teens
		{
			...
			input:    "پلاک یازده",
			expected: "پلاک 11",
			numbers:  []DetectedNumber{{Number: 11}},
		},
		{
			name:     "plate_thirteen",
			input:    "پلاک سیزده",
			expected: "پلاک 13",
			numbers:  []DetectedNumber{{Number: 13}},
		},
		...
		// Tens
		{
			...
			input:    "خیابان بیست",
			expected: "خیابان 20",
			numbers:  []DetectedNumber{{Number: 20}},
		},
		{
			name:     "street_thirty",
			input:    "خیابان سی",
			expected: "خیابان 30",
			numbers:  []DetectedNumber{{Number: 30}},
		},
		{
			name:     "street_forty",
			input:    "خیابان چهل",
			expected: "خیابان 40",
			numbers:  []DetectedNumber{{Number: 40}},
		},
		...
		// Compound numbers
		{
			...
			expected: "خیابان 23",
			numbers:  []DetectedNumber{{Number: 23}},
		},
		{
			name:     "alley_thirty_five",
			input:    "کوچه سی و پنج",
			expected: "کوچه 35",
			numbers:  []DetectedNumber{{Number: 35}},
		},
		{
			name:     "plate_forty_seven",
			input:    "پلاک چهل و هفت",
			expected: "پلاک 47",
			numbers:  []DetectedNumber{{Number: 47}},
		},
		...
		// Addresses with multiple numbers
		{
			...
			numbers:  []DetectedNumber{{Number: 24}, {Number: 10}, {Number: 3}},
		},
		{
			name:     "address_ordinal_street",
			input:    "خیابان پنجم پلاک دوازده واحد هفت",
			expected: "خیابان 5 پلاک 12 واحد 7",
			numbers:  []DetectedNumber{{Number: 5}, {Number: 12}, {Number: 7}},
		},
		...
		// Mixed digits and words
		{
			...
			input:    "پلاک بیست 22",
			expected: "پلاک 20 22",
			numbers:  []DetectedNumber{{Number: 20}, {Number: 22}},
		},
		{
			name:     "duplicate_numbers",
			input:    "واحد سه 3",
			expected: "واحد 3 3",
			numbers:  []DetectedNumber{{Number: 3}, {Number: 3}},
		},
		...
		// Phone numbers
		{
			...
			expected: "تلفن 0 920",
			numbers:  []DetectedNumber{{Number: 0}, {Number: 920}},
		},
		...
		// Larger numbers
		{
			...
			expected: "123",
			numbers:  []DetectedNumber{{Number: 123}},
		},
		{
			name:     "two_hundred_fifty_six",
			input:    "دویست و پنجاه و شش",
			expected: "256",
			numbers:  []DetectedNumber{{Number: 256}},
		},
		{
			name:     "thousand_two_hundred",
			input:    "هزار و دویست",
			expected: "1200",
			numbers:  []DetectedNumber{{Number: 1200}},
		},
		{
			name:     "nineteen_ninety_nine",
			input:    "هزار و نهصد و نود و نه",
			expected: "1999",
			numbers:  []DetectedNumber{{Number: 1999}},
		},
		...
		// Ordinals beyond 10
		{
			...
			input:    "دوازدهم",
			expected: "12",
			numbers:  []DetectedNumber{{Number: 12}},
		},
		{
		...
		// Mix of thousands and smaller units
		{
			...
			numbers:  []DetectedNumber{{Number: 1020}, {Number: 203}},
		},
		...
		},
		{
			...
			numbers:  []DetectedNumber{{Number: 1}, {Number: 2}},
		},
	}

	detector := NewPersianNumberDetector()
